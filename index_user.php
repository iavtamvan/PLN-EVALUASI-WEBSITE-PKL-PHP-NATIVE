<?php
session_start();
include 'pages/api/config.php';
$username = "". $_SESSION["username"];
$idUser = "". $_SESSION["id_user"];

$sql = "SELECT * FROM pln_evaluasi";
$query = mysqli_query($db, $sql);
$user = mysqli_fetch_assoc($query);
$numPlnEvaluasi = mysqli_num_rows($query);

$sqlUser = mysqli_query($db, "select * from pln_user where RULE='user'");
$numPlnUser = mysqli_num_rows($sqlUser);
$userPln = mysqli_fetch_assoc($sqlUser);
...
<head>
  ...
  <title>PLN Evaluasi | Dashboard</title>
...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/tables/data_user.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Evaluasi</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="pages/api/logout.php" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="http://TIM IT PLN">TIM IT PLN</a>.</strong>
    All rights reserved.

...
$idUser = "". $_SESSION["id_user"];//if (!$username) {
if (!$username) {
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data JAR</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<!--            </div>-->
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                $sql = mysqli_query($db, "select * from pln_evaluasi where PIC ='LAB';");
...
//                  echo "<a href='../../api/telkom_apps/controller/update_api.php?pindah=updateUserAktif&id_user=" . $ambil['id_user'] . "'>Aktifkan</a>";
                  ...
                  echo "<td>";
//                  echo "<a href='../../api/telkom_apps/controller/delete_user.php?id_user=" . $ambil['id_user'] . "'>Hapus Teknisi | </a>";
                  echo "<a href='../forms/edit_komentar_admin_lab.php?ID_EVALUASI=" . $ambil['ID_EVALUASI'] . "'>Edit Komentar</a>";
//                  echo "<a href='../../api/telkom_apps/controller/update_api.php?pindah=updateUserAktif&id_user=" . $ambil['id_user'] . "'>Aktifkan</a>";
                  echo "</td>";
